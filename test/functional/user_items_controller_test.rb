...
class UserItemsControllerTest < ActionController::TestCase
  ...
  test "should create user_item" do
    assert_difference('UserItem.count') do
      post :create, user_item: { item_type: @user_item.item_type, ref_id: @user_item.ref_id, user_id: @user_item.user_id }
    end
  ...
  test "should update user_item" do
    put :update, id: @user_item, user_item: { item_type: @user_item.item_type, ref_id: @user_item.ref_id, user_id: @user_item.user_id }
    assert_redirected_to user_item_path(assigns(:user_item))
  end
