(function () {
        ...
        ! function (t) {
            ...
            if (!e("json")) {
                ...
                if (n = function (t, o) {
                    ...
                    return e = c = null, i ? n = 2 == i ? function (t, o) {
                        var e, n = {},
                            c = a.call(t) == y;
                    ...
                    var b = {
                        ...
                        I = function (t, o, e, p, i, s, u) {
                            ...
                            if ("object" == typeof l && l)
                                if (y = a.call(l), y != h || r.call(l, "toJSON")) "function" == typeof l.toJSON && (y != f && y != d && y != S || r.call(l, "toJSON")) && (l = l.toJSON(t));
                                else if (l > -1 / 0 && 1 / 0 > l) {
                                if (v) {
    ...
    function () {
        PostToWanelo.ContentScraper.Selector = function (t) {
            var o, e, r, n, c, a, p, i;
            for (o = t.attribute, p = t.selector, c = 0, a = p.length; a > c; c++)
                if (r = p[c], e = null != (i = PostToWanelo.querySelectorAll(r)) ? i[0] : void 0, n = null, e && (o ? n = e.getAttribute(o) : e.innerText ? n = e.innerText : e.textContent && (n = e.textContent)), n = null != n ? n.trim() : void 0) return n;
            return !1
        }, PostToWanelo.ContentScraper.MetaTag = function (t) {
            var o, e, r, n, c, a, p;
            for (c = t.name, r = 0, n = c.length; n > r; r++)
                if (e = c[r], o = null != (a = PostToWanelo.getMetaTagByName(e)) ? null != (p = a.getAttribute("content")) ? p.trim() : void 0 : void 0) return o;
            return null
    ...
    function () {
        PostToWanelo.Availability = {
            ...
            var t, o, e, r, n, c, a;
            for (t = !1, a = PostToWanelo.ContentScraper.DEFINITIONS, n = 0, c = a.length; c > n; n++)
                if (r = a[n], o = PostToWanelo.ContentScraper[r.type](r), e = r.check_in_stock && (null != o ? o.toLowerCase().match(PostToWanelo.ContentScraper.IN_STOCK_PATTERN) : void 0), (null != o ? o.toLowerCase().match(PostToWanelo.ContentScraper.DEFAULT_OOS_PATTERN) : void 0) || e) {
                    t = !0;
                    break
                }
            return t
    ...
    function () {
        ...
        PostToWanelo.Price = {
                ...
                return e = t.selector instanceof Array ? t.selector : [t.selector],
                    function () {
                        var t, r, n, c, a;
                        for (c = 0, a = e.length; a > c; c++)
                            if (n = e[c], t = PostToWanelo.querySelector(n), r = PostToWanelo.ContentScraper.Price.scan(t, o) || PostToWanelo.ContentScraper.getAttribute(t, "value"), t && "0.00" !== r) return r
                    }()
            },
            function (o) {
                return o.scan = function (t, e) {
                    ...
                    return o = function (t) {
                        var o, e, r, n, c;
                        for (o = PostToWanelo.cssProperty(t.element, "fontWeight"), c = ["bold", "bolder"], r = 0, n = c.length; n > r; r++)
                            if (e = c[r], o === e) return !0;
                    ...
                    if (s = new PostToWanelo.Patterns(e), a = r.children, 0 === a.length)
    ...
    function () {
        PostToWanelo.StoreScraper = function () {
            ...
            var e, r, n, c;
            for (c = PostToWanelo.storeScrapers, r = 0, n = c.length; n > r; r++)
                if (e = c[r], e = new e(o, t), e.valid()) return e;
            return void 0
        ...
        PostToWanelo.StorenvyScraper = function (o) {
            ...
            return e(r, o), r.prototype.url = function () {
                ...
                for (o = PostToWanelo.querySelectorAll(".store-name-area a, .store-name a, a.store_profile"), r = 0, n = o.length; n > r; r++)
                    if (t = o[r], e = null != (c = t.getAttribute("href")) ? c.trim() : void 0, e && e.match(/\/stores\//)) return e.match(/^http:\/\//) || (e = "http://" + this.host() + e), e
            }, r.prototype.name = function () {
                var t, o, e;
    ...
    function () {
        PostToWanelo.rulesForStore = function (t) {
            ...
            "bluefly.com": {
                ...
                price: [".pdpFinalPrice", "span[itemprop='price']", ".new_price"],
                availability: {
                    matches: [
                        [".soldout-label", "SOLD OUT"],
                        [".overlay_text", "Sold out"],
                        [".pdpWaitListEmailHeaderContainerContent", "We're sorry! This style is sold out"]
                    ]
                }
            },
            "blushprom.com": {
    ...
    function () {
        ...
        PostToWanelo.AnnTaylorScraper = function (o) {
            ...
            return e(r, o), r.prototype.productAvailability = function () {
                ...
                return "" === this.selectorText("#MainProductImage")
            }, r.prototype.host = function () {
    ...
    function () {
        ...
        PostToWanelo.FarfetchScraper = function (o) {
            ...
            }, r.prototype.productBrand = function () {
                return this.selectorText("#ContentPlaceBody_TemplateBody_hItemTitle") || ""
            }, r.prototype.productName = function () {
                return this.selectorText(".productFriendly") || ""
            }, r
    ...
    function () {
        ...
        PostToWanelo.NewlookScraper = function (o) {
            ...
            return e(r, o), r.prototype.productAvailability = function () {
                ...
                var e, r, n, c;
                for (r = PostToWanelo.querySelectorAll(t), n = 0, c = r.length; c > n; n++)
    ...
    function () {
        ...
        PostToWanelo.UoionlineScraper = function (o) {
            function r() {
                return t = r.__super__.constructor.apply(this, arguments)
            }
            return e(r, o), r.prototype.productAvailability = function () {
                return "OutOfStock" === PostToWanelo.ContentScraper.Availability() ? "OutOfStock" : this.selectorTextMatches("title", "Page not found") ? "OutOfStock" : this.selectorExist("#add-to-cart") ? "InStock" : "OutOfStock"
            }, r.prototype.host = function () {
                return "uoionline.com"
            }, r
        }(PostToWanelo.StoreScraper), PostToWanelo.storeScrapers.push(PostToWanelo.UoionlineScraper)
    }.call(this),
    function () {
        var t, o = {}.hasOwnProperty,
            e = function (t, e) {
        ...
        this.waneloBookmarklet = function (t) {
            ...
            if (null == t && (t = {}), !PostToWanelo.getElementById("wanelo-overlay")) {
                ...
                return PostToWanelo.openOverlay(e, function (t) {
                    return PostToWanelo.postInApp(PostToWanelo.extend({
                        images: t
